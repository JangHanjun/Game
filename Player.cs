...
public class PlayerMove : MonoBehaviour
{
    ...
    void Update() //단발적인 키 입력
    {
        ...
        //점프
        if (dManager.isAction ? false : Input.GetButtonDown("Jump") && !anim.GetBool("isJumping"))
        { 
    ...
    {
        // 이동을 위한 코드
        float h = dManager.isAction ? 0 :  Input.GetAxisRaw("Horizontal");  //대화중에는 이동 불가
